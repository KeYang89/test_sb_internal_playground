<?php
$view->script('userprofile-settings', 'sb/userprofile:app/bundle/userprofile-settings.js', ['sb-pkframework']) ?>
        ...
        <div class="pk-width-content">
            ...
            <ul id="tab-content" class="uk-switcher uk-margin">
                <li class="uk-form-horizontal">
                    <div class="uk-grid uk-grid-width-medium-1-2" data-uk-grid-margin>
                        <div>
                            ...
                            <sb-fields :config="$options.fields.list" :values.sync="config.list"></sb-fields>
                        </div>
                        <div>
                ...
                <li class="uk-form-horizontal">
                    <div class="uk-grid uk-grid-width-medium-1-2" data-uk-grid-margin>
                        <div>
                            ...
                            <sb-fields :config="$options.fields.details" :values.sync="config.details"></sb-fields>
                ...
                <li class="uk-form-horizontal">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <select v-if="uploadFields.length" v-model="config.avatar_field" class="uk-form-width-medium">
                                <option value="">{{ 'Use SBWebApplication default' | trans }}</option>
                    ...
                    <sb-fields :config="$options.fields.general" :values.sync="config"></sb-fields>

<?php $view->script('fields-userprofile', 'sb/userprofile:app/bundle/fields.js', ['sb-pkframework', 'uikit-nestable']) ?>

<?php if ($frameworkValid !== true) : ?>
	<div class="uk-alert uk-alert-warning">
		<p><?=$frameworkValid?></p>
		<p><a href="<?=$view->url('admin/system/marketplace/extensions')?>">
				<?=__('Download and install the SB Framework via the SBWebApplication Marketplace.')?>
			</a></p>
	</div>
<?php endif; ?>

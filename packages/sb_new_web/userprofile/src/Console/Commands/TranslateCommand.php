...
/**
 * Create .pot file:
 *  `php ./sb_new_web extension:translate sb/userprofile`
 * Create .php files
 *  `php ./sb_new_web userprofile:translate [en_US]`
 */
namespace SB\Userprofile\Console\Commands;
...
class TranslateCommand extends Command
{
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		if (file_exists($rootpath . '/packages/sb_new_web/' . $this->extension . '/languages/base.php')) {
			$extraStrings = include($rootpath . '/packages/sb_new_web/' . $this->extension . '/languages/base.php');

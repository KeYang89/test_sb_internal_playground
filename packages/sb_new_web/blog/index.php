...
use SBWebApplication\Blog\Content\ReadmorePlugin;
use SBWebApplication\Blog\Event\PostListener;
use SBWebApplication\Blog\Event\RouteListener;
...
return [
    ...
    'nodes' => [
        ...
        'blog' => [
            'name' => '@blog',
            'label' => 'Blog',
            'controller' => 'SBWebApplication\\Blog\\Controller\\SiteController',
            'protected' => true,
            'frontpage' => true
        ]
    ...
    'routes' => [
        ...
        '/blog' => [
            'name' => '@blog',
            'controller' => 'SBWebApplication\\Blog\\Controller\\BlogController'
        ],
        '/api/blog' => [
            'name' => '@blog/api',
            'controller' => [
                'SBWebApplication\\Blog\\Controller\\PostApiController',
                'SBWebApplication\\Blog\\Controller\\CommentApiController'
            ]
        ]

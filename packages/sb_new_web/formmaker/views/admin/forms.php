<?php $view->script('forms-formmaker', 'sb/formmaker:app/bundle/forms.js', ['vue', 'uikit-nestable']) ?>

<?php if ($frameworkValid !== true) : ?>
	<div class="uk-alert uk-alert-warning">
		<p><?=$frameworkValid?></p>
		<p><a href="<?=$view->url('admin/system/marketplace/extensions')?>">
				{{ 'Download and install the SB Framework via the SBWebApplication Marketplace.' | trans}}
			</a></p>
	</div>
<?php endif; ?>
	...
	<div class="uk-overflow-container">
		...
		<div class="pk-table-fake pk-table-fake-header" :class="{'pk-table-fake-border': !forms || !forms.length}">
			...
			<div class="pk-table-width-150">{{ 'Plugin code' | trans }}<a class="uk-icon-info uk-icon-hover uk-margin-small-left"
					data-uk-tooltip="{delay:200}" :title="'Add this code to any SBWebApplication content to show the form.' | trans"></a></div>

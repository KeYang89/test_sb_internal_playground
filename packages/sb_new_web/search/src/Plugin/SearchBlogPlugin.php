...
namespace SBsearch\Search\Plugin;

use SBsearch\Search\Helpers\EXSearchHelper;
use SBsearch\Search\Event\SearchEvent;

use SBWebApplication\Blog\Model\Post;
use SBWebApplication\Blog\Model\Comment;

use SBWebApplication\Component\Database\ORM\Repository;
...
class SearchBlogPlugin implements EventSubscriberInterface
{
	...
	{ 
		...
		$params = App::module('sbsearch/search')->config('defaults');

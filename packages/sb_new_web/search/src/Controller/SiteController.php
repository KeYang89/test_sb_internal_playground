 ...
 */
namespace SBsearch\Search\Controller;

use SBWebApplication\Application as App;
use SBsearch\Search\Helpers\EXFilterInput;
use SBsearch\Search\Helpers\EXSearchHelper;// as EXSearchHelper;
use SBsearch\Search\Helpers\EXPagination;
use SBsearch\Search\SearchExtension;
use SBsearch\Search\Entity\Search;
use SBsearch\Search\Event\SearchEvent;
use SBWebApplication\Framework\Controller\Controller;
use SBWebApplication\Framework\Controller\Exception;
use SBWebApplication\Extension\Extension;
//use SBsearch\Search\Model\SearchKeywords;
...
class SiteController 
{
    ...
    {
        $this->extension = App::module('sbsearch/search');
    ...
    */
    ...
    {	
		...
		return [
			'$view' => [
				'title'		 => __('Search'),
				'name' => 'sbsearch/search:views/form/placeholder.php',
				//'name' => 'search:views/form/placeholder.php',
				'name' => 'sbsearch/search/form/placeholder.php',
				],
			'posts'				=> [], 

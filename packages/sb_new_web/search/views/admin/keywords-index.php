<?php $view->style('statistics-index', 'sbsearch/search:assets/css/search.css') ?>
<?php $view->script('statistics-index', 'sbsearch/search:app/bundle/statistics-index.js', 'vue') ?>

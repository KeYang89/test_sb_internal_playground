                ...
                <div>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls uk-form-controls-text">
                            ...
                            <sbvideo-fields-raw :config="$options.fields.teaser_show" :values.sync="widget.data"></sbvideo-fields-raw>

                        </div>
                    </div>

                    <sbvideo-fields :config="$options.fields.teaser_top" :values.sync="widget.data"></sbvideo-fields>

                    <sbvideo-fields :config="$options.fields.template[widget.data.teaser.template]" :values.sync="widget.data"></sbvideo-fields>


                </div>
                <div>

                    <sbvideo-fields :config="$options.fields.teaser_bottom" :values.sync="widget.data"></sbvideo-fields>
                    ...
                    <sbvideo-fields :config="$options.fields.teaser_columns" :values.sync="widget.data"></sbvideo-fields>
...
<script>
    ...
    window.Widgets.components['sbvideo-video-projects:settings'] = module.exports;

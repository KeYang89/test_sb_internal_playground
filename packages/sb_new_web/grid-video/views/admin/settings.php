<?php $view->style('codemirror'); $view->script('video-settings', 'sbvideo/video:app/bundle/video-settings.js', ['vue', 'editor', 'uikit-nestable']) ?>

<div id="video-settings" class="uk-form">
		...
		<div class="pk-width-sidebar">
			...
			<div class="uk-panel">
				...
				<ul class="uk-nav uk-nav-side pk-nav-large" data-uk-tab="{ connect: '#tab-content' }">
					<li><a><i class="pk-icon-large-brush uk-margin-right"></i> {{ 'Video content' | trans }}</a></li>
					<li><a><i class="pk-icon-large-settings uk-margin-right"></i> {{ 'Video settings' | trans }}</a></li>
			...
			<ul id="tab-content" class="uk-switcher uk-margin">
				<li>
					...
					<div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
						<div data-uk-margin>
							...
							<h2 class="uk-margin-remove">{{ 'Video content' | trans }}</h2>
					...
					<div class="uk-form-horizontal">
						...
						<div class="uk-form-row">
							<label for="form-videotitle" class="uk-form-label">{{ 'Video title' | trans }}</label>

							<div class="uk-form-controls">
								<input id="form-videotitle" class="uk-width-1-1" type="text" name="video_title"
									   v-model="config.video_title">
							</div>
						</div>
					</div>
					...
					<div class="uk-form-stacked uk-margin">
						<div class="uk-form-row">
							<span class="uk-form-label">{{ 'Video text' | trans }}</span>

							<div class="uk-form-controls">
								<v-editor id="form-intro" :value.sync="config.video_text"
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input-image :source="config.video_image" class="pk-image-max-height"></input-image>
						</div>
					</div>
				...
				<li>
					...
					<div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
						<div data-uk-margin>
							...
							<h2 class="uk-margin-remove">{{ 'Video settings' | trans }}</h2>
					...
					<div class="uk-grid uk-grid-width-large-1-2 uk-form-horizontal" data-uk-grid-margin="">
						<div>
							<sbvideo-fields :config="$options.fields.video" :values.sync="config"></sbvideo-fields>

							<sbvideo-fields :config="$options.fields.teaser_columns" :values.sync="config"></sbvideo-fields>
						...
						<div>
							...
							<div class="uk-form-row">
								...
								<div class="uk-form-controls uk-form-controls-text">
									...
									<sbvideo-fields-raw :config="$options.fields.teaser_show" :values.sync="config"></sbvideo-fields-raw>

								</div>
							</div>

							<sbvideo-fields :config="$options.fields.teaser_top" :values.sync="config"></sbvideo-fields>

							<sbvideo-fields :config="$options.fields.template[config.teaser.template]" :values.sync="config"></sbvideo-fields>

							<sbvideo-fields :config="$options.fields.teaser_bottom" :values.sync="config"></sbvideo-fields>
				...
				<li>
					...
					<div class="uk-form-horizontal">
						...
						<sbvideo-fields :config="$options.fields.project" :values.sync="config"></sbvideo-fields>
				...
				<li>
					...
					<div class="uk-form-horizontal">
						...
						<sbvideo-fields :config="$options.fields.general" :values.sync="config"></sbvideo-fields>

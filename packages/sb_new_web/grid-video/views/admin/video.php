<?php $view->script('admin-video', 'sbvideo/video:app/bundle/admin-video.js', ['vue']) ?>

<div id="video-projects" class="uk-form uk-form-horizontal" v-cloak>
	...
	<div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
		...
		<div class="uk-position-relative" data-uk-margin>
			...
			<div data-uk-dropdown="{ mode: 'click' }">
				<a class="uk-button uk-button-primary" :href="$url.route('admin/video/project/edit')">
					{{ 'Add project' | trans }}</a>
	...
	<div class="uk-overflow-container">
		<table class="uk-table uk-table-hover uk-table-middle">
			...
			<tr class="check-item" v-for="project in projects" :class="{'uk-active': active(project)}">
				...
				<td>
					<a :href="$url.route('admin/video/project/edit', { id: project.id })">{{ project.title }}</a>
				</td>

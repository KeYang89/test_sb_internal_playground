 ...
 * @var SBVideo\Video\Model\Project[] $projects
 * @var \SBWebApplication\Widget\Model\Widget $widget
...
<div class="uk-margin uk-grid uk-grid-match <?= $grid ?>" data-uk-grid-margin data-uk-grid-match="target: '>div>.uk-panel'">
  ...
  <?php foreach ($projects as $project) : ?>
       <?= $view->render("sbvideo/video/templates/teaser_{$widget->get('teaser.template', 'panel')}.php", compact('project', 'config', 'teaser_config')); ?>
  <?php endforeach; ?>

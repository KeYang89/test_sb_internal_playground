...
function colorPickerIESet(){
  ...
  function changeColor(e) {
    ...
    var color =rgb2hex($('#color-label').css("background-color"));
    colorPicker.value=color;
    colorPickerOp.value=color;
  }
...
function colorPickerIE(obj){
  $('.IEColorPicker').toggle();
}
function loadCanvas() {

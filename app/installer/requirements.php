...
/**
 * This class specifies all SBWebApplication requirements and optional recommendations.
 *
 * @author Tobias Schultze <http://tobion.de>
 * @author Fabien Potencier <fabien@symfony.com>
 */
class SBWebApplicationRequirements extends RequirementCollection
{
    ...
    public function __construct($path)
    {
        ...
        $this->addRequirement(
            ...
            sprintf('You are running PHP version "<strong>%s</strong>", but SBWebApplication needs at least PHP "<strong>%s</strong>" to run.
                Before using SBWebApplication, upgrade your PHP installation, preferably to the latest version.',
...
return new SBWebApplicationRequirements($path);

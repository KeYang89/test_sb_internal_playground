...
<html>
    <head>
        <title>SBWebApplication Installer Errors</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="uk-height-viewport uk-flex uk-flex-center uk-flex-middle uk-text-center">
            <div class="tm-container">
                ...
                <img class="uk-margin-large-bottom" src="app/system/assets/images/sb_new_web-logo-large-black.svg" alt="SBWebApplication">

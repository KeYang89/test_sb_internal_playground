    ...
    <div v-show="update && view == 'index'">
        ...
        <div v-show="hasUpdate">
            ...
            <template v-if="!update.msg">
                ...
                <p>{{ 'Update to S&B WebApplication %version% automatically or download the package and install it manually!' | trans update }}</p> 
        ...
        <div v-show="!hasUpdate">
            <h2>{{ 'You have the latest version of S&B WebApplication.' | trans }}</h2>
            <p>{{ 'You have the latest version of S&B WebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' | trans update }}</p>
        </div>

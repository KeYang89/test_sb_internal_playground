<template>
    ...
    <div>
        ...
        <div class="uk-grid uk-grid-medium uk-grid-match uk-grid-width-small-1-3 uk-grid-width-xlarge-1-6" data-uk-grid-margin="observe:true">
        ...
        <div class="uk-modal" v-el:modal>
            <div class="uk-modal-dialog uk-modal-dialog-large" v-if="pkg">
                ...
                <div class="pk-modal-dialog-badge">
                    <button class="uk-button" disabled v-show="isInstalled(pkg)">{{ 'Pass' | trans }}</button>
                    <button class="uk-button uk-button-primary" @click="mailto:(pkg.email)" v-else>{{ 'Interested' | trans }}</button>
                </div>
                ...
                <div class="uk-modal-header">
                    ...
                    <ul class="uk-subnav uk-subnav-line uk-margin-bottom-remove">
                        ...
                        <li class="uk-text-muted" v-if="pkg.price">{{'Price %price%' | trans {price:pkg.price} }}</li>
                        <li class="uk-text-muted" v-if="pkg.notes">{{ pkg.notes }}</li>
                    </ul>
                </div>
                ...
                <div class="uk-grid">
                    ...
                    <div class="uk-width-medium-1-2">
                        ...
                        <ul class="uk-grid uk-grid-small" data-uk-grid-margin>
                            <li v-if="pkg.phone"><a class="uk-button" :href="pkg.phone" target="_blank">{{ 'Phone' | trans }}</a></li>
                            <li v-if="pkg.email"><a class="uk-button" :href="pkg.email" target="_blank">{{ 'Email' | trans }}</a></li>
...
<script>
    ...
    module.exports = {
        ...
        props: {
            ...
            type: {type: String, default: 'sb_new_web_market_goods'},
            installed: {
        ...
        methods: {
            ...
            query: function () {
                ...
                var url = this.api, options = {emulateJSON: true};

...
use SBWebApplication\Installer\Package\PackageFactory;
...
return [
    ...
    'main' => function ($app) {
        ...
        if ($this->config['enabled']) {
            ...
            $app['routes']->add([
                'path' => '/installer',
                'name' => '@installer',
                'controller' => 'SBWebApplication\Installer\Controller\InstallerController'
            ]);
    ...
    'routes' => [
        ...
        '/system/package' => [
            'name' => '@system/package',
            'controller' => 'SBWebApplication\Installer\Controller\PackageController'
        ],
        '/system/marketplace' => [
            'name' => '@system/marketplace',
            'controller' => 'SBWebApplication\Installer\Controller\MarketplaceController'
        ],
        '/system/update' => [
            'name' => '@system/update',
            'controller' => 'SBWebApplication\Installer\Controller\UpdateController'
        ]

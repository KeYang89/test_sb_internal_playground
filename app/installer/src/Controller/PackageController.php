...
class PackageController
{
    ...
    {
        $packages = array_values(App::package()->all('sb_new_web-theme'));
    ...
    {
        $packages = array_values(App::package()->all('sb_new_web-extension'));
    ...
    public function uploadAction($type)
    {
        ...
        if ($package->get('type') !== 'sb_new_web-' . $type) {
            App::abort(400, __('No SBWebApplication %type%', ['%type%' => $type]));
        }

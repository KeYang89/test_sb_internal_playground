...
namespace SBWebApplication\Installer\Package;

use SBWebApplication\Application as App;
use SBWebApplication\Installer\Helper\Composer;
...
class PackageManager
{
    ...
    public function enable($packages)
    {
        ...
        foreach ($packages as $package) {
            ...
            } elseif ($package->getType() == 'sb_new_web-extension') {
    ...
    public function disable($packages)
    {
        ...
        foreach ($packages as $package) {
            ...
            if ($package->getType() == 'sb_new_web-extension') {

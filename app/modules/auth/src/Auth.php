...
namespace SBWebApplication\Auth;
...
use SBWebApplication\Auth\Event\LogoutEvent;
use SBWebApplication\Auth\Exception\BadCredentialsException;
use SBWebApplication\Auth\Handler\HandlerInterface;

...
namespace SBWebApplication\Database\ORM\Loader;

use Doctrine\Common\Annotations\SimpleAnnotationReader;
use SBWebApplication\Database\ORM\Annotation\Annotation;
use SBWebApplication\Database\ORM\Annotation\BelongsTo;
use SBWebApplication\Database\ORM\Annotation\Column;
use SBWebApplication\Database\ORM\Annotation\Entity;
use SBWebApplication\Database\ORM\Annotation\HasOne;
use SBWebApplication\Database\ORM\Annotation\OrderBy;
use SBWebApplication\Database\ORM\Relation\HasMany;
use SBWebApplication\Database\ORM\Relation\ManyToMany;
...
class AnnotationLoader implements LoaderInterface
{
     ...
     * @var string
     */
    protected $namespace = 'SBWebApplication\Database\ORM\Annotation';

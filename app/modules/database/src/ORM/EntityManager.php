...
namespace SBWebApplication\Database\ORM;

use SBWebApplication\Database\Connection;
use SBWebApplication\Database\Events;
...
class EntityManager
{
    ...
    public function related($entities, $name, QueryBuilder $query)
    {
        ...
        if (!class_exists($class = 'SBWebApplication\Database\ORM\\Relation\\'.$mapping['type'])) {

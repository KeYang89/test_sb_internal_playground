...
namespace SBWebApplication\Module;

use SBWebApplication\Application;
use SBWebApplication\Module\Loader\CallableLoader;
use SBWebApplication\Module\Loader\LoaderInterface;
use SBWebApplication\Module\Loader\ModuleLoader;
...
class ModuleManager implements \IteratorAggregate
{
    ...
    protected $defaults = [
        'main' => null,
        'type' => 'module',
        'class' => 'SBWebApplication\Module\Module',
        'config' => []
    ];

<?php
namespace SBWebApplication\Application\Console;

use SBWebApplication\Container;
...
class Command extends BaseCommand
{
    ...
    /**
     * Set the SBWebApplication application instance.
     *
    ...
    /**
     * Set the SBWebApplication config.
     *
     * @param array $config
     */

...
trait DbUtil
{
    ...
    public function getConnection()
    {
        if (isset($GLOBALS['db_type'], $GLOBALS['db_username'], $GLOBALS['db_password'],
            ...
            $conn = \Doctrine\DBAL\DriverManager::getConnection(array_merge(['wrapperClass' => 'SBWebApplication\Database\Connection'], $realDbParams), null, null);
        } else {
            $params = [
                'driver' => 'pdo_sqlite',
                'memory' => true
            ...
            $conn = \Doctrine\DBAL\DriverManager::getConnection(array_merge(['wrapperClass' => 'SBWebApplication\Database\Connection'], $params));
        }

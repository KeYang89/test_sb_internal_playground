...
namespace SBWebApplication\Kernel;

use SBWebApplication\Event\EventDispatcherInterface;
use SBWebApplication\Kernel\Event\ControllerEvent;
use SBWebApplication\Kernel\Event\ExceptionEvent;
use SBWebApplication\Kernel\Event\KernelEvent;
use SBWebApplication\Kernel\Event\RequestEvent;
use SBWebApplication\Kernel\Exception\BadRequestException;
use SBWebApplication\Kernel\Exception\ConflictException;
use SBWebApplication\Kernel\Exception\ForbiddenException;
use SBWebApplication\Kernel\Exception\HttpException;
use SBWebApplication\Kernel\Exception\InternalErrorException;
use SBWebApplication\Kernel\Exception\MethodNotAllowedException;
use SBWebApplication\Kernel\Exception\NotFoundException;
use SBWebApplication\Kernel\Exception\UnauthorizedException;

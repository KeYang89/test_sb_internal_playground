...
use SBWebApplication\Routing\Annotation\Route as RouteAnnotation;
...
class AnnotationLoader implements LoaderInterface
{
     ...
     * @var string
     */
    protected $routeAnnotation = 'SBWebApplication\Routing\Annotation\Route';
    ...
    protected function getAnnotationReader()
    {
        if (!$this->reader) {
            ...
            $this->reader->addNamespace('SBWebApplication\Routing\Annotation');
        }

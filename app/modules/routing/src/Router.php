...
use SBWebApplication\Routing\Generator\UrlGeneratorDumper;
use SBWebApplication\Routing\Generator\UrlGeneratorInterface;
use SBWebApplication\Routing\Loader\LoaderInterface;
use SBWebApplication\Routing\RequestContext as Context;
...
class Router implements RouterInterface, UrlGeneratorInterface
{
    ...
    public function __construct(ResourceInterface $resource, LoaderInterface $loader, RequestStack $stack, array $options = [])
    {
        ...
        $this->options  = array_replace([
            ...
            'generator' => 'SBWebApplication\Routing\Generator\UrlGenerator'
        ], $options);
    }
    ...
    protected function getResolver(array $parameters = [])
    {
        ...
        if (!isset($this->resolver[$resolver])) {
            ...
            if (!is_subclass_of($resolver, 'SBWebApplication\Routing\ParamsResolverInterface')) {
                return null;
            }

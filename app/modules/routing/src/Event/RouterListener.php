...
namespace SBWebApplication\Routing\Event;

use SBWebApplication\Event\EventSubscriberInterface;
use SBWebApplication\Kernel\Exception\MethodNotAllowedException as MethodNotAllowedHttpException;
use SBWebApplication\Kernel\Exception\NotFoundException as NotFoundHttpException;
...
class RouterListener implements EventSubscriberInterface
{
    ...
    public function onRequest($event, $request)
    {
        ...
        try {
            ...
            $message = sprintf('This page does not exist');

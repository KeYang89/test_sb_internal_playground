...
use SBWebApplication\Installer\Installer;
...
class SetupCommand extends Command
{
     ...
     * {@inheritdoc}
     */
    protected $description = 'Setup a SBWebApplication installation';
    ...
    protected function configure()
    {
        ...
        $this->addOption('title', 't', InputOption::VALUE_OPTIONAL, 'Site title', 'SBWebApplication');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->line("Setting up SBWebApplication installation...");

...
class BuildCommand extends Command
{
     ...
     */
    protected $excludes = [
        '^(tmp|config\.php|sb_new_web.+\.zip|sb_new_web.db|.+\.map)',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (true !== $zip->open($zipFile = "{$path}/sb_new_web-{$vers}.zip", \ZipArchive::CREATE | \ZipArchive::OVERWRITE)) {

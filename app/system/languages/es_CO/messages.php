<?php return array (
  ...
  'Value' => 'Valor',
  'Username' => 'Usuario',
  'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' => '¿Tu lenguaje no esta disponible? Ayúdanos traduciendo SBWebApplication en tu propio idioma en %link%.',
  'No Limit' => 'Sin Limete',
  'Code' => 'Código',
  ...
  'Cache' => 'Cache',
  'SBWebApplication %version% is available.' => 'SBWebApplication %version% esta disponible.',
  ...
  'Unknown' => 'Desconocido',
  'You have the latest version of SBWebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Tienes la última versión de SBWebApplication. No necesitas actualizar. Sin embargo, si quieres reinstalar la versión %version%, puedes descargar el paquete y reinstalar manualmente.',
  'Reset' => 'Restablecer',
  'Height' => 'Alto',
  ...
  'Renamed.' => 'Renombrado.',
  'Url' => 'URL',
  'No SBWebApplication %type%' => 'Sin SBWebApplication %type%',
  'Hidden' => 'Oculto',
  ...
  'Thumbnail' => 'Miniatura',
  'Your SBWebApplication database has been updated successfully.' => 'Tu base de datos de SBWebApplication ha sido correctamente actualizada.',
  ...
  'Existing SBWebApplication installation detected. Choose different table prefix?' => 'Se detecto una instalación previa de SBWebApplication. ¿Escoger un prefijo de tabla diferente?',
  'View' => 'Vista',
  'Login Redirect' => 'Redirección de Ingreso',
  'General' => 'General',
  'SBWebApplication has been updated! Before we send you on your way, we have to update your database to the newest version.' => '¡SBWebApplication ha sido actualizado! Antes de continuar, tenemos que actualizar tu base de datos a la nueva versión.',
  '%d EB' => '%d EB',
  6 => '6',
  '- Assign -' => '- Asignar -',
  'Hostname' => 'Servidor',
  ...
  'From Name' => 'Remitente',
  'You have the latest version of SBWebApplication.' => 'Tienes la última versión de SBWebApplication.',

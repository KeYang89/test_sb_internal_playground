<?php return array (
  ...
  'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' => 'Dilinizi bulamadınız mı? SBWebApplication çevirisine yardımcı olmak için %link% bağlantısına bakabilirsiniz. ',
  ...
  'Cache' => 'Önbellek',
  'SBWebApplication %version% is available.' => 'SBWebApplication %version% sürümü yayınlanmış.',
  ...
  'Unknown' => 'Bilinmeyen',
  'You have the latest version of SBWebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Son SBWebApplication sürümünü kullanıyorsunuz. Herhangi bir güncelleme gerekmiyor. Bununla birlikte %version% sürümünü yeniden yüklemek istiyorsanız, paketi indirip el ile yeniden yükleyebilirsiniz.',
  'Reset' => 'Sıfırla',
  'Height' => 'Yükseklik',
  'SBWebApplication Version' => 'SBWebApplication Sürümü',
  ...
  'Url' => 'İnternet adresi',
  'No SBWebApplication %type%' => 'SBWebApplication %type% yok',
  'Hidden' => 'Gizli',
  ...
  'Your SBWebApplication database has been updated successfully.' => 'SBWebApplication veritabanı güncellendi.',
  ...
  'SBWebApplication Installer' => 'SBWebApplication Yükleyicisi',
  '%d YB' => '%d YB',
  'Login!' => 'Oturum Açın!',
  ...
  'Existing SBWebApplication installation detected. Choose different table prefix?' => 'Varolan bir SBWebApplication kurulumu algılandı. Farklı bir tablo öneki seçmek ister misiniz?',
  'View' => 'Görünüm',
  'Login Redirect' => 'Oturum Açma Yönlendirmesi',
  'General' => 'Genel',
  'SBWebApplication has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'SBWebApplication güncellendi. Kullanmaya başlamadan önce veritabanınızın da güncellenmesi gerekiyor. ',
  '%d EB' => '%d EB',
  6 => '6',
  '- Assign -' => '- Ata -',
  'Hostname' => 'Sunucu Adı',
  ...
  'Footer' => 'Altbilgi',
  'Update SBWebApplication' => 'SBWebApplication Yazılımını Güncelle',
  'From Name' => 'Kimden Adı',
  'You have the latest version of SBWebApplication.' => 'Son SBWebApplication sürümünü kullanıyorsunuz.',

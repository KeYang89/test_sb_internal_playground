<?php return array (
  ...
  'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' => 'Is jouw taal niet beschikbaar? Help SBWebApplication met het vertalen van jouw eigen taal op %link%?',
  ...
  'Cache' => 'Cache',
  'SBWebApplication %version% is available.' => 'SBWebApplication %version% is beschikbaar.',
  ...
  'Logged in' => 'Ingelogd',
  'Unknown' => 'Onbekend',
  'You have the latest version of SBWebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Je hebt de laatste versie van SBWebApplication. Het is niet nodig om te updaten. Wanneer je versie %version% opnieuw wilt installeren kan dit automatisch, maar ook handmatig door het pakket opnieuw te downloaden en te installeren.',
  'Reset' => 'Resetten',
  'Height' => 'Hoogte',
  'SBWebApplication Version' => 'SBWebApplication versie',
  ...
  'Renamed.' => 'Hernoemd.',
  'Url' => 'URL',
  'No SBWebApplication %type%' => 'Geen SBWebApplication %type%',
  'Hidden' => 'Verborgen',
  ...
  'Your SBWebApplication database has been updated successfully.' => 'De SBWebApplication-database is succesvol geüpdatet.',
  ...
  'Existing SBWebApplication installation detected. Choose different table prefix?' => 'Bestaande SBWebApplication-installatie gevonden. Ander tabelvoorvoegsel gebruiken?',
  'View' => 'Weergave',
  'Login Redirect' => 'Login doorstuuradres',
  'General' => 'Algemeen',
  'SBWebApplication has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'SBWebApplication is geüpdatet. Voordat je doorgaat is het nodig om de database te updaten naar de nieuwste versie.',
  '%d EB' => '%d EB',
  6 => '6',
  '- Assign -' => '- Toewijzen -',
  'Hostname' => 'Naam host',
  ...
  'You have the latest version of SBWebApplication.' => 'Je hebt de laatste versie van SBWebApplication.',

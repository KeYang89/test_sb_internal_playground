<?php return array (
  ...
  'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' => 'La tua lingua non è disponibile? Aiutaci a tradurre SBWebApplication nella tua lingua su %link%',
  ...
  'Testemail' => 'Email test inviata da SBWebApplication',
  'URL' => 'URL',
  'Depth' => 'Profondità',
  ...
  'Cache' => 'Cache',
  'SBWebApplication %version% is available.' => 'E\' disponibile la versione %version% di SBWebApplication. Aggiorna ora...',
  ...
  'Logged in' => 'Connesso',
  'Unknown' => 'Sconosciuto',
  'You have the latest version of SBWebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => 'Possiedi l\'ultima versione di SBWebApplication. Non è necessario aggiornare. Tuttavia, se desideri re-installare la versione versione%%, puoi scaricare il pacchetto e re-installarlo manualmente.',
  'Reset' => 'Reimposta',
  'Height' => 'Altezza',
  'SBWebApplication Version' => 'Versione SBWebApplication',
  ...
  'Renamed.' => 'Rinominato.',
  'Url' => 'Url',
  'No SBWebApplication %type%' => 'Nessun %type% di SBWebApplication',
  'Hidden' => 'Nascosto',
  ...
  'Thumbnail' => 'Miniatura',
  'Your SBWebApplication database has been updated successfully.' => 'Il database di SBWebApplication è stato aggiornato con successo.',
  ...
  'SBWebApplication Installer' => 'Installazione del SBWebApplication',
  '%d YB' => '%d YB',
  'Login!' => 'Accedi!',
  ...
  'Existing SBWebApplication installation detected. Choose different table prefix?' => 'Esistenti installazione SBWebApplication rilevato. Scegli prefisso tavolo diverso?',
  'View' => 'Vista',
  'Login Redirect' => 'Reindirizzamento Login',
  'General' => 'Generale',
  'SBWebApplication has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'SBWebApplication è stato aggiornato! Prima di lasciarti libero di andare, dobbiamo aggiornare il tuo database all\'ultima versione.',
  '%d EB' => '%d EB',
  6 => '6',
  '- Assign -' => '- Assegna -',
  'Hostname' => 'Nome host',
  ...
  'Update SBWebApplication' => 'Aggiorna SBWebApplication',
  'From Name' => 'Nome mittente',
  'You have the latest version of SBWebApplication.' => 'La tua versione di SBWebApplication è aggiornata.',

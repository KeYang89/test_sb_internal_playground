<?php return array (
  ...
  'Value' => 'Værdi',
  'Username' => 'Brugernavn',
  'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' => 'Er dit sprog ikke tilgængeligt? Hjælp venligst, ved at oversætte SBWebApplication til dit sprog på %link%.',
  ...
  'Cache' => 'Cache',
  'SBWebApplication %version% is available.' => 'SBWebApplication %version% er tilgængelig.',
  ...
  'Unknown' => 'Ukendt',
  'You have the latest version of SBWebApplication. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' => '',
  'Reset' => 'Nulstil',
  'Height' => 'Højde',
  ...
  'Thumbnail' => 'Thumbnail',
  'Your SBWebApplication database has been updated successfully.' => 'Din SBWebApplication database er blevet opdateret korrekt.',
  ...
  'Existing SBWebApplication installation detected. Choose different table prefix?' => 'En eksisterende SBWebApplication installation fundet. Vælg andet tabelpræfix?',
  'View' => 'Se',
  'Login Redirect' => '',
  'General' => 'Generel',
  'SBWebApplication has been updated! Before we send you on your way, we have to update your database to the newest version.' => 'SBWebApplication blev opdateret! Før vi kan sende dig videre, bliver vi nødt til at opdatere din database til den nyeste version.',
  '%d EB' => '%d EB',
  6 => '6',
  '- Assign -' => '- Tildel -',
  'Hostname' => 'Hostnavn',
  ...
  'Footer' => 'Footer',
  'Update SBWebApplication' => 'Opdatér SBWebApplication',
  'From Name' => 'Fra Navn',
  'You have the latest version of SBWebApplication.' => 'Du har den seneste version af SBWebApplication',

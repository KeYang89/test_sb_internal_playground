...
use SBWebApplication\Kernel\Event\ExceptionListener;

return [

    'name' => 'system',

    'main' => 'SBWebApplication\\System\\SystemModule',
    ...
    'routes' => [
        ...
        '/' => [
            'name' => '@system',
            'controller' => 'SBWebApplication\\System\\Controller\\AdminController'
        ],
        '/system/migration' => [
            'name' => '@system/migration',
            'controller' => 'SBWebApplication\\System\\Controller\\MigrationController'
        ]
    ...
    'events' => [
        ...
        'boot' => function ($event, $app) {
            ...
            if (!$app['debug']) {
                $app->subscribe(new ExceptionListener('SBWebApplication\System\Controller\ExceptionController::showAction'));
            }

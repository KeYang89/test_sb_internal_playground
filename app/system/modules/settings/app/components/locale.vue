<template>
    ...
    <p>{{{ 'Is your language not available? Please help out by translating SBWebApplication into your own language on %link%.' | trans {link:link} }}}</p>
...
<script>
    ...
    module.exports = {
        ...
        computed: {
            ...
            link: function () {
                return '<a href="https://www.transifex.com/sb_new_web/sb_new_web-cms/">Transifex</a>';
            },

...
use SBWebApplication\Site\Event\MaintenanceListener;
use SBWebApplication\Site\Event\NodesListener;
use SBWebApplication\Site\Event\PageListener;
use SBWebApplication\Site\MenuHelper;
...
return [
    ...
    'main' => 'SBWebApplication\\Site\\SiteModule',

    'autoload' => [

        'SBWebApplication\\Site\\' => 'src'
    ...
    'nodes' => [
        ...
        'page' => [
            'name' => '@page',
            'label' => 'Page',
            'controller' => 'SBWebApplication\\Site\\Controller\\PageController::indexAction'
        ]
    ...
    'routes' => [
        ...
        '/' => [
            'name' => '@site',
            'controller' => 'SBWebApplication\\Site\\Controller\\NodeController'
        ],
        '/api/site/menu' => [
            'name' => '@site/api/menu',
            'controller' => 'SBWebApplication\\Site\\Controller\\MenuApiController'
        ],
        '/api/site/node' => [
            'name' => '@site/api/node',
            'controller' => 'SBWebApplication\\Site\\Controller\\NodeApiController'
        ],
        '/api/site/page' => [
            'name' => '@site/api/page',
            'controller' => 'SBWebApplication\\Site\\Controller\\PageApiController'
        ]
    ...
    'events' => [
        ...
        'package.enable' => function ($event, $package) use ($app) {
            if ($package->getType() === 'sb_new_web-theme') {

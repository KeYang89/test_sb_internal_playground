...
use SBWebApplication\Mail\Mailer;
use SBWebApplication\Mail\Plugin\ImpersonatePlugin;
...
return [
    ...
    'routes' => [
        ...
        '/system' => [
            'name' => '@system',
            'controller' => 'SBWebApplication\\Mail\\Controller\\MailController'
        ]

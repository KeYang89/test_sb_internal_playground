...
return [
    ...
    'routes' => [
        ...
        '/system/finder' => [
            'name' => '@system/finder',
            'controller' => 'SBWebApplication\\Finder\\Controller\\FinderController'
        ],
        '/site/storage' => [
            'name' => '@site/storage',
            'controller' => 'SBWebApplication\\Finder\\Controller\\StorageController'
        ]

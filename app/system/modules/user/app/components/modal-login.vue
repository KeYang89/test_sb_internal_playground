    ...
    <div>
        <v-modal v-ref:login>
            ...
            <div class="uk-text-center">
                ...
                <img class="uk-margin" :src="$url('app/system/assets/images/sb_new_web-logo-text-black.svg')" alt="SBWebApplication">
            ...
            login: function () {
                ...
                login().then(null, function (res) {
                    ...
                    if (res.data.csrf) {
                        ...
                        this.$cache.set('_session', window.$sb_new_web.csrf);
                        this.$session.flush();

...
use SBWebApplication\Widget\Model\Widget;
use SBWebApplication\Widget\PositionHelper;
use SBWebApplication\Widget\PositionManager;
use SBWebApplication\Widget\WidgetManager;
...
return [
    ...
    'routes' => [
        ...
        '/site/widget' => [
            'name' => '@site/widget',
            'controller' => 'SBWebApplication\\Widget\\Controller\\WidgetController'
        ],
        '/api/site/widget' => [
            'name' => '@site/api/widget',
            'controller' => 'SBWebApplication\\Widget\\Controller\\WidgetApiController'
        ]
